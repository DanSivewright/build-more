import type { HeroOverlapBlock as HeroOverlapBlockProps } from "src/payload-types"
...
type Props = {
  className?: string
} & HeroOverlapBlockProps

const HeroOverlapBlock: React.FC<Props> = ({
  className,
  richText,
  headingLines,
  links,
...
export default HeroOverlapBlock
