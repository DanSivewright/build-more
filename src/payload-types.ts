...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CallToActionImageOffsetBlock".
 */
export interface CallToActionImageOffsetBlock {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "ArchiveOffsetBlock".
 */
export interface ArchiveOffsetBlock {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CarouselOffsetBlock".
 */
export interface CarouselOffsetBlock {
  background: 'EDEDED' | 'C9DAF0' | 'E08C5B' | '41BD62' | 'FFF9D7';
  image: string | Media;
  slides?:
    | {
